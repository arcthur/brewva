...
This note is archived as a completed delegation-taxonomy migration record.
The stable contract now lives in the architecture, reference, guide, and
operator docs listed above. Keep this file for cutover rationale and historical
normalization context, not for current API truth.
