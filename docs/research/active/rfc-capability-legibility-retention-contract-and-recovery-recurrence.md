...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| Intent (1)                  | Domain-anchored prompt ("interpret unclear instructions as engineering tasks in this cwd") + env/git context injection + per-turn relevant-skill reminders | Per-turn advisory SkillCard shortlist with deterministic explicit-mention/path/recent-path/name reasons; `discover_skills` for text search                                          | COVERED except two prompt lines (R5)                                   |
