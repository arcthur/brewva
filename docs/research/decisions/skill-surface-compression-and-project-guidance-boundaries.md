...
- `selection.when_to_use` is optional advisory text rendered beside the description. The hosted lifecycle no longer scores authored trigger bullets, removed alias fields, or legacy keyword overlap for cold-start skill selection.
