...
- Runtime truth remains untouched. Presentation policy does not persist transformed answers, alter event tape, create inspect surfaces, or redefine `runtime.authority`, `runtime.inspect`, or `runtime.maintain`.
