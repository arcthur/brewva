...
- `packages/brewva-gateway/src/runtime-plugins/context-transform.ts` remains a lifecycle shell, while hosted compaction control, context injection, and telemetry live in narrower adapters
