...
- Memory, recall, precedent, solution records, knowledge, narrative memory,
  deliberation memory, and optimization continuity:
...
- Workflow, skills, worker results, task state, scheduling, follow-up,
