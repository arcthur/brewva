...
Runtime surface member count: 157.

- `authority.claim.resolve`
- `authority.claim.upsert`
- `authority.conventions.applyApprovedChange`
- `authority.conventions.decideChangeRequest`
- `authority.conventions.submitChangeRequest`
...
- `inspect.conventions.getDigest`
- `inspect.conventions.getState`
- `inspect.conventions.listPending`
- `inspect.conventions.listRequests`
...
- `maintain.workbench.commitBaseline`
- `maintain.workbench.evict`
- `maintain.workbench.note`
...
| `inspect.context` / `maintain.context`                                                       | Numeric context status, compaction, provider cache, visible-read state, and prompt-stability observations.                 |
