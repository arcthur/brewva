...
Continuation anchors are tape anchors with product continuation semantics.
They are replayable evidence for Work Cards, transcripts, export bundles, and
channel inspect, but they do not become a second memory store or task
authority. The stable persisted event family remains `tape.handoff`.
