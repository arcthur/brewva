...
| Excuse                                          | Reality                                                                                    |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------ |
| "Unit tests pass, so it works"                  | Unit tests are not a verifier pass. Real flows can fail with green unit tests.             |
...
| "Fixing it myself is faster"                    | `verifier` does not patch product code. Hand off defects to implementation.                |
