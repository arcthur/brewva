...
| Devil's Advocate             | `explorer`           | useful for alternative explanations and missing-context pressure   |
| Optional empirical follow-up | `verifier`           | best fit for executable confirmation and break-it probing          |
