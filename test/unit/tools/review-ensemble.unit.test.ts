...
function buildReviewOutcome(
  ...
  return {
    ...
    data: {
      kind: "consult",
      consultKind: "review",
      conclusion: input.primaryClaim ?? `${lane} completed`,
      lane,
    ...
    const tasks = buildReviewLaneDelegationTasks({
      ...
      packet: {
        ...
        consultBrief: {
          ...
          successCriteria: "Each lane returns a clear disposition with evidence.",
        },
    ...
    const outcomes = materializeReviewLaneOutcomes([
      {
        ...
        taskName: "review-boundaries",
        taskPath: "/review-boundaries",
        nickname: "review-boundaries",
        depth: 1,
        forkTurns: "none",
        ...
        resultData: {
          kind: "consult",
          consultKind: "review",
          conclusion: "The boundary remains stable.",
      ...
      },
      {
        ...
        runId: "lane-failed",
        agent: "explorer",
        targetName: "review-concurrency",
        delegate: "review-concurrency",
        taskName: "review-concurrency",
        taskPath: "/review-concurrency",
        nickname: "review-concurrency",
        depth: 1,
        forkTurns: "none",
        gateReason: "make_judgment",
        modelCategory: "deep-reasoning",
