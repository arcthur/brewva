...
export interface ExportAgentState {
    systemPrompt?: string;
    tools?: Array<{
        name: string;
        description: string;
 ...
 */
export declare function exportSessionToHtml(sm: SessionManager, state?: ExportAgentState, options?: ExportOptions | string): Promise<string>;
/**
