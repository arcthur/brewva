...
} from "../src/internal/tui/internal-opentui-runtime.js";
...
/**
 * Create the full-screen alternate-screen renderer for the interactive shell.
 * `createCliRendererConfig` already defaults to screenMode "alternate-screen" +
 * externalOutputMode "passthrough", so the whole shell (transcript + composer +
 * overlays) renders live in the alt screen — there is no native-scrollback
 * commit pipeline. Enables the native debug overlay when BREWVA_TUI_STATS=1.
 */
