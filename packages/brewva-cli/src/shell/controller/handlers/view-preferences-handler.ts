...
export interface ShellViewPreferencesHandlerContext {
...
export class ShellViewPreferencesHandler {
  constructor(private readonly context: ShellViewPreferencesHandlerContext) {}
