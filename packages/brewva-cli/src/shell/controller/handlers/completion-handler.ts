...
import type { ShellCompletionProvider } from "../../domain/completion-provider.js";
import {
...
export interface ShellCompletionHandlerContext {
...
export class ShellCompletionHandler {
  readonly #dismissedBySessionId = new Map<string, DismissedCompletionState>();

  constructor(private readonly context: ShellCompletionHandlerContext) {}
