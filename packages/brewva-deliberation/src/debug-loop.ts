...
import { persistSessionJsonArtifact, readSessionJsonArtifact } from "./session-artifacts.js";
...
export interface DebugLoopVerificationSummary {
  eventId: string;
  recordedAt: number;
