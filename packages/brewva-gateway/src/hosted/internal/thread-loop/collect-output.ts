...
import type {
  ...
  BrewvaSubscribablePromptSession,
...
import { ToolAttemptBindingRegistry, formatAttemptId } from "./attempts/tool-attempt-binding.js";
import { getHostedTurnTransitionCoordinator } from "./turn-transition.js";

type SubscribablePromptSession = BrewvaSubscribablePromptSession;
