import type { RoasterEventRecord, TruthFact, TruthFactStatus, TruthLedgerEventPayload, TruthState } from "../types.js";
...
export const TRUTH_LEDGER_SCHEMA = "roaster.truth.ledger.v1" as const;
...
export function foldTruthLedgerEvents(events: RoasterEventRecord[]): TruthState {
