...
export const TOOL_ACTION_POLICY_BY_NAME: Record<string, ToolActionPolicy> = {
  ...
  glob: workspaceRead(),
  source_read: workspaceRead(),
  resource_read: workspaceRead(),
  source_patch_prepare: workspacePatch(),
  source_patch_apply: workspacePatch(),
  look_at: workspaceRead(),
  discover_skills: runtimeObserve(),
  code_outline: workspaceRead(),
  code_digest: workspaceRead(),
  code_surface: workspaceRead(),
  code_deps: workspaceRead(),
  code_reverse_deps: workspaceRead(),
  code_cycles: workspaceRead(),
  code_callers: workspaceRead(),
  code_callees: workspaceRead(),
  ...
  lsp_status: workspaceRead(),
  lsp_hover: workspaceRead(),
  lsp_definition: workspaceRead(),
  lsp_references: workspaceRead(),
  lsp_type_definition: workspaceRead(),
  lsp_implementation: workspaceRead(),
  lsp_rename: workspacePatch(),
  lsp_file_rename: workspacePatch(),
  lsp_code_action: workspacePatch(),
  lsp_format: workspacePatch(),
  ...
  create_plan_map: controlStateMutation(),
  get_plan_map: runtimeObserve(),
  open_plan_ticket: controlStateMutation(),
  claim_plan_ticket: controlStateMutation(),
  unclaim_plan_ticket: controlStateMutation(),
  resolve_plan_ticket: controlStateMutation(),
  close_plan_ticket: controlStateMutation(),
  rescope_plan_ticket: controlStateMutation(),
  record_fog: controlStateMutation(),
  graduate_fog: controlStateMutation(),
...
export function getToolActionPolicyForClass(actionClass: ToolActionClass): ToolActionPolicy {
  return clonePolicy(TOOL_ACTION_POLICY_BY_CLASS[actionClass]);
}
