...
import { normalizeSkillOutputs } from "../skills/api.js";
import {
...
import { coerceReviewReportArtifact } from "../skills/api.js";
import { isSemanticArtifactSchemaId } from "../skills/api.js";
import type { SemanticArtifactSchemaId, SkillSemanticBindings } from "../skills/types.js";
...
function readWorkflowSemanticBindings(payload: {
...
function deriveWorkflowSemanticBindings(
  ...
  payload: { semanticBindings?: SkillSemanticBindings },
): SkillSemanticBindings | undefined {
