...
import { MAX_REASONING_CONTINUITY_BYTES, REASONING_CONTINUITY_SCHEMA } from "./types.js";
...
export function coerceReasoningRevertPayload(value: unknown): ReasoningRevertPayload | null {
  ...
  return {
    ...
    revertSequence,
    toCheckpointId,
    ...(normalizeNonEmptyString(value.fromCheckpointId)
      ? { fromCheckpointId: normalizeNonEmptyString(value.fromCheckpointId)! }
      : {}),
    fromBranchId,
    newBranchId,
    newBranchSequence,
