...
import type { ResourceLeaseBudget, ResourceLeaseRecord } from "../../context/api.js";
import type { ResourceLeaseHydrationState, SessionHydrationFold } from "./fold.js";
import { readEventPayload, readNonNegativeNumber } from "./fold.js";

export const SESSION_HYDRATION_RESOURCE_LEASE_TURN_LIFECYCLE_PLACEMENT = {
  foldId: "session_hydration_resource_lease",
  source: "packages/brewva-runtime/src/domain/sessions/hydration/fold-resource-lease.ts",
