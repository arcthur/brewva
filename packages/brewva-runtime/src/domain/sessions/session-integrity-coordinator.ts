...
import { deriveRecoveryCanonicalization } from "../recovery/api.js";
import type { RecoveryWalStore } from "../recovery/api.js";
import type { IntegrityIssue, IntegrityStatus } from "./integrity.js";
...
export const SESSION_INTEGRITY_TURN_LIFECYCLE_PLACEMENT = {
  ...
  source: "packages/brewva-runtime/src/domain/sessions/session-integrity-coordinator.ts",
